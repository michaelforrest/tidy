package tidy.mvc.model {
	...
	public class StringFormatting {
		...
		public static function formatTime24Hour(date : Date) : String {
		...
		private static var LINES_DELIMITERS : Array = ["\r\n", "\n\r", "\r", "\n"];

		public static function stripInLines ( s : String ) : Array
		{
			var res : Array = [];
			var delimiter_index : Number = 0;
			var delimeter : String;
			while(res.length<2 && delimiter_index<LINES_DELIMITERS.length){
				delimeter = LINES_DELIMITERS[delimiter_index];
...
//		public static function capitalise(image_id : String) : String {
//			return null;
//		}
	}
}
